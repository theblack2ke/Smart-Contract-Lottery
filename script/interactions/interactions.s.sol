...
contract CreateSubscription is Script {
    function createSubscriptionUsingConfig() public returns (uint256, address) {
        ...
        //Then let's create subscription...
    }

    function createSubscription(address vrfCoordinator, address account) public returns (uint256, address) {
        console.log("Create subscription Id on chain Id:", block.chainid);
...
contract FundSubscription is Script, CodeConstant {
    ...
    /**
     * To fund a subscription we will need
     * 1- VRFCoordinator ✅
     * 2- subscriptionId ✅
     * 3- LINK Token ✅ (This is where the tx is going to be call to )
     */
